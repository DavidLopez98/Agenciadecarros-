<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NuevoAdmin.aspx.cs" Inherits="Agencia.NuevoAdmin" %>
...
Type="Integer"></asp:CompareValidator>
 ...
 <br />
                     ...
                     <asp:HyperLink  onclick="alert('Gracias por registrarse, en caso de que no fue asi intentelo de nuevo, nos importa mucho su informacion')" ID="HyperLink1"  runat ="server" NavigateUrl="~/Administrador-Usuarios.aspx">Volver a la pagina administrador</asp:HyperLink>

     <br />
     <br />


                     <asp:HyperLink  onclick="alert('Gracias por registrarse, en caso de que no fue asi intentelo de nuevo, nos importa mucho su informacion')" ID="HyperLink2"  runat ="server" NavigateUrl="~/Login.aspx">Volver a Login</asp:HyperLink>
